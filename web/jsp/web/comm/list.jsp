                ...
                <div class="table-responsive">
                    <table class="table table-hover" style="margin-bottom: 0;">
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<%=basePath%>/comm_findByIds.do?commid=<s:property value="#d.commid"/>&type=edit" class="btn btn-info btn-xs"><i class="fa fa-edit"></i> 编辑</a>
                            </td>
                            <td>
